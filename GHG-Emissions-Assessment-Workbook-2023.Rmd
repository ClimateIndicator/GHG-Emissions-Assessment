...
```{r plot_emissions_2023,fig.height=9,fig.width=10,fig.path="results/",dev=c('png','pdf','svg')}
...
write.xlsx(data_table,'results/section_2_2_table_2023.xlsx')
write.csv(data_table,'results/section_2_2_table_2023.csv',row.names = FALSE)
write.csv(spread(data_ghg %>% select(-var,-source),label,value),'results/ghg_emissions_co2e_2023.csv',row.names = FALSE)
...
saveWorkbook(wb,'results/ghg_emissions_co2e_2023.xlsx',overwrite=T)



data_2023 <- data
data_ghg_2023 <- data_ghg
save(data_2023,data_ghg_2023,file="results/data/data_2023.RData")
