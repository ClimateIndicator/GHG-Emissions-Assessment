...
data_ghg <- data_ghg %>% 
  mutate(source=ifelse(var=="ch4","PRIMAP CR v2.6* + GFED v4.1*",source)) %>% 
  mutate(source=ifelse(var=="n2o","PRIMAP CR v2.6* + GFED v4.1*",source)) %>% 
...
p_ghg_1 <- data_ghg %>% 
  ...
  theme_wl() +
  scale_x_continuous(limits=c(1970,2023),breaks=c(1970,1980,1990,2000,2010,2020),expand = c(0, 0)) +
