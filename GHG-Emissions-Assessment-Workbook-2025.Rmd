...
``` {r totals_conventions_years,fig.height=3,fig.width=8}
...
data_conventions <- rbind(
  ...
  data %>% 
    ...
    mutate(convention = "WGIII update + additional sources"),
  data %>%
...
data_conventions <- data_conventions %>% 
  ...
  mutate(component=ifelse(is.na(component),"Energy, IPPU, Agriculture & Waste",component))
...
data_conventions$convention <- fct_relevel(data_conventions$convention,
                                "Inventory-aligned",
                                "WGIII update + additional sources",
                                "WGIII update")
...
## Save figure
#  
ggsave(plot,filename = "plot_emissions_differences_2025.png",path = "results/",device = "png",height = 3,width=8,dpi=300)
ggsave(plot,filename = "plot_emissions_differences_2025.pdf",path = "results/",device = cairo_pdf,height = 3,width=8)
ggsave(plot,filename = "plot_emissions_differences_2025.svg",path = "results/",device = 'svg',height = 3,width=8)
