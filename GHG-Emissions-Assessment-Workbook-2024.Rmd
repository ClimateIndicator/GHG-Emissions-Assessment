...
data_ghg_labels <- data_ghg %>% filter(year==2022) %>% select(year=year,label,value) %>% arrange(label)
...
write.csv(spread(data_ghg %>% select(-var,-source),label,value),'results/ghg_emissions_co2e_2024.csv',row.names = FALSE)
